        ...
        return (
            <div>
                ...
                <div className="medicine_middle_class">
                    <Container>
                        <div className="section_title">
                            <h2 className="pb-0">Protinex Fruit Mix 400gm<Image src={heartbeat} width="50"
                                height="20" alt="heart beat icon" /></h2>
                        </div>
                        <div className="medicine_content">
                            ...
                            <p className="blue_price">Rs. 600</p>
                ...
                <div className="specialities pt-5 pb-5">
                    <Container>
                        <div className="section_title">
                            <h2>Similar Products<Image src={heartbeat} width="50"
                                height="20" alt="heart beat icon" /></h2>
                        </div>
                        <Row>
                            <Col lg={4} md={6} sm={12}>
