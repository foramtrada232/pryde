...
export default class Appoinment_booking_v2 extends React.Component {
			...
			<div>
					...
					<Container>
						...
						<Row>
							...
							<Col xl={4} lg={6} className="mt-3">
								<label>Doctor</label>
								<select className="form-group">
									<option defaultValue="john Deo">john Deo</option>
									<option defaultValue="john Deo">john Deo</option>
									<option defaultValue="john Deo">john Deo</option>
								</select>
							</Col>
				...
				<section className="appointment_calendar_1 border-top border-bottom">
					<Container>
						...
						<h5 className="pick_date">Pick a Time</h5>
						<Container>
							<div className="row select_date_appoinment">
								...
								<div className="form-check">
									<input className="form-check-input" type="radio" name="time" id="nine" defaultValue="eight" />
