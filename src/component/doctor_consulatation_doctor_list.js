...
export default class Doctor_consulatation_doctor_list extends React.Component {
					...
					<Container>
						...
						<div className="geolocation_menu" style={{ display: 'none' }}>
							<Row>
								...
								<Col lg={2} md={12}>
									<a href="appoinment_booking_v3-3.htm" className="w-100"><button className="btn search_btn">Search</button></a>
								</Col>
							</Row>
						</div>
							...
							<Row>
								...
								<Col lg={8}>
									<div className="doctor_details">
										...
										<a href="doctor_consulatation_doctor_details_page"><button className="ml-0 mt-2" type="button">Consult</button></a>
									</div>
								</Col>
							</Row>
							<Row>
